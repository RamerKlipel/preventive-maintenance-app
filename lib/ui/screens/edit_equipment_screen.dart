...
class EditEquipmentScreen extends StatefulWidget {
  ...
  @override
  State<EditEquipmentScreen> createState() => _EditEquipmentScreen();
}

class _EditEquipmentScreen extends State<EditEquipmentScreen> {
  ...
  void initState() {
    super.initState();
    _nameController.text = widget.equipmentData['NMEQUPMENT'] ?? '';
    _machinaryType.text = widget.equipmentData['DSTPEQUIPMENT'] ?? '';
    _machinaryLocal.text = widget.equipmentData['DSLOCALEQUIPMENT'] ?? '';
    _nextMaintenace.text = widget.equipmentData['DATEEQUIPMENT'] ?? '';

    if (widget.equipmentData['CHECKLIST'] != null) {
      final checklist = widget.equipmentData['CHECKLIST'] as List<dynamic>;
      _checklistItems = checklist.map((item) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Editar Equipamento"), centerTitle: true),
